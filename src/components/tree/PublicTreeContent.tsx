...
interface Props {
  ...
  getLifespanLabel: (p: Person) => string;
}

export function PublicTreeContent(props: Props) {
  const {
    tree, treeId, displayPersons, relationships, selectedPersonId, selectedPerson,
    viewMode, effectiveRoot, setViewMode, setSelectedPersonId, setRootPersonId,
    handleSearchSelect, getLifespanLabel,
  } = props;
  return (
